...
export default function Theme9({
  ...
  if (isCoverUndangan) {
    return (
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black to-theme9-primary opacity-80"></div>
        ...
        >
          <div className="bg-white p-4 rounded-2xl text-center w-[80%] mx-auto border border-dashed border-theme9-primary">
            <p>Kepada Yth.</p>
  ...
  return (
    <div className="relative bg-black">
      ...
      {/* Informasi Mempelai */}
      <div className="py-16 px-6 bg-black text-theme9-secondary rounded-t-3xl -mt-8 relative z-10">
        <div className="flex flex-col gap-4 text-center">
          <motion.div
            ...
            viewport={{ once: false }}
          >
            <Badge className="text-xs rounded-full bg-theme9-primary text-white px-4">
              Undangan Pernikahan
            </Badge>
          </motion.div>
          <motion.div
      ...
      <div className="py-16 px-6 bg-[url('/images/theme6/bg2.png')] bg-cover bg-center">
        ...
        <div className="py-10 flex flex-col gap-6">
          ...
          >
            ...
            <div className="p-4 border-2 border-theme9-primary rounded-2xl">
      ...
      <div className="py-16 bg-[#040032]">
        <motion.div
          ...
          className="pb-8"
        >
          <h2 className="text-3xl font-medium text-center font-recoleta-alt text-theme9-secondary">
            Galeri Kami
          </h2>
        </motion.div>
        <Galeri
      ...
      <div className="py-16 px-6 bg-gradient-to-b from-black to-theme9-primary  border-t border-white/20">
        ...
        <div className="flex flex-col gap-6">
          ...
          {ucapan?.map((item, index) => (
            <div
              className="bg-white border-l-3 border-theme9-primary rounded-2xl p-4 flex flex-col gap-3 bg-gradient-to-br from-white to-theme9-primary/15"
              key={index}
            >
              <div className="flex gap-3">
                <div className="w-8 h-8 bg-theme9-primary rounded-full flex items-center justify-center font-semibold text-white">
                  {item.name.charAt(0)}
                </div>
