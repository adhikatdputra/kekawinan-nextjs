...
const features = [
  ...
  },
  {
    ...
    img: "/images/features/CUSTOMIZE.jpg",
    isNew: false,
  ...
  },
  {
    ...
    img: "/images/features/KIRIMVIAWHATSAPP.jpg",
    isNew: false,
  ...
  },
  {
    ...
    img: "/images/features/LOVESTORY.jpg",
    isNew: true,
  ...
  },
  {
    ...
    img: "/images/features/KEHADIRAN.jpg",
    isNew: false,
  ...
  },
  {
    ...
    img: "/images/features/QRCODE.jpg",
    isNew: true,
  ...
  },
  {
    ...
    img: "/images/features/KOLABORATOR.jpg",
    isNew: true,
    color: "from-green-400/20 to-emerald-500/30",
  },
];
    ...
    <section className="relative bg-green-soft-kwn py-16 md:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-14">
          ...
          >
            Dari template hingga manajemen RSVP tamu — semua fitur premium
            tersedia gratis.
          </motion.p>
        </div>
              ...
              <SwiperSlide key={index} className="!h-auto">
                <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 h-full flex flex-col cursor-grab active:cursor-grabbing">
                  ...
                  <div className="relative h-52 overflow-hidden flex-shrink-0">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-t ${feature.color} mix-blend-multiply`}
                    />
        ...
        <div className="flex items-center justify-center gap-4 mt-10">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 font-medium tabular-nums">
            <span className="text-green-kwn font-bold">
