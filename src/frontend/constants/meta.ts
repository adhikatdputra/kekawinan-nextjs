export const home = {
  title: "Kekawinan | Buat Undangan Pernikahan Digital Gratis & Mudah",
  description:
...
export const login = {
  title: "Login | Kekawinan - Undangan Pernikahan Digital",
  description:
...
export const register = {
  title: "Daftar | Kekawinan - Buat Undangan Pernikahan Digital",
  description:
